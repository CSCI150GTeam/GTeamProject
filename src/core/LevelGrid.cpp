...
{
    ifstream infile;
    infile.open("Resources\\levels\\level.txt");
    if( !infile.is_open() )
...
{
    //Load images
    SDL_Surface* grass = loadImage("Resources\\images\\grass.bmp");          //1
    SDL_Surface* ice = loadImage("Resources\\images\\ice.bmp");              //2
    SDL_Surface* lava = loadImage("Resources\\images\\lava.bmp");            //3
    SDL_Surface* stone = loadImage("Resources\\images\\stone.bmp");          //4
    SDL_Surface* water = loadImage("Resources\\images\\water.bmp");          //5
    SDL_Surface* waterDrops = loadImage("Resources\\images\\waterDrops.bmp");       //6
