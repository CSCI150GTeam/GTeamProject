...
Menu::Menu()
{
    ...
    IMG_MENU3 = Utility::loadImage("resources\\ui_menu3.png");
    IMG_MENU5 = Utility::loadImage("resources\\ui_menu5.png");
...
Menu::~Menu()
{
    ...
    SDL_FreeSurface(IMG_MENU3);
    SDL_FreeSurface(IMG_MENU5);
...
void Menu::drawScreen(int)
{
	...
	case MS_MAIN:
	    //Buttons
	    Utility::applySurface(0, 0, IMG_MENU5);
	    //Text
	...
	case MS_SINGLE:
	    //Buttons
	    Utility::applySurface(0, 0, IMG_MENU3);
	    //Text
	...
	case MS_EDIT:
	    ...
	    break;
	case MS_SET:
	    Utility::applySurface(0, 0, IMG_MENU1);
